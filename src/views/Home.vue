<template>
  <v-layout row wrap>
    <v-flex text-xs-center>
      <!-- header -->
      <h1 class="primary--text display-1 font-weight-medium my-2">TODOS</h1>
      <p class="primary--text display-6 font-weight-regular my-3">Technologies utilisées : Vue CLI 3 + Vue Router + Vuex + Vuetify</p>
      <v-card>
        <v-list class="pa-0">
          <v-list-tile>
            <v-list-tile-action>
